...
cmsRun anaGenJet_LO_cfg.py output="GenJet_LO_R23457_7000_Mar2_Z2pt80to120.root" maxEvents="1000000" processType="NSD" ptHatLow="80" ptHatHigh="120" sqrtS="7000" &> run_LO_7000_80_120.log
